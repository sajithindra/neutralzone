<template>
        <v-container style="width: 40%; padding-top: 5% ;">
                <h1 class="text-center text-indigo-600 p-3 font-bold text-2xl">User Registration</h1>
                <v-form>
                    ...
                    <v-container style="width: 50%;" class="text-center">
                        <v-btn @click="signin()" text color="purple-accent-3" class="w-40 h-20">Register</v-btn>
                    </v-container>
                </v-form>
        </v-container>
</template>
